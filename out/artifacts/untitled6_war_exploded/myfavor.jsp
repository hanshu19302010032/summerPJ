...
<main class="flex-container">
    <div class="card flex-24-24">
        ...
        <form class="card-body flex-container" id="form">
            <label>share your favorites with others?</label>

            <c:choose>
                <c:when test="${requestScope.user.canBeSeenFavors==1}">
                    <input type="radio" name="canBeSeenFavor" checked value="1">yes
                    <input type="radio" name="canBeSeenFavor" value="0">no
                </c:when>
                <c:when test="${requestScope.user.canBeSeenFavors!=1}">
                    <input type="radio" name="canBeSeenFavor" value="1">yes
                    <input type="radio" name="canBeSeenFavor" checked value="0">no
                </c:when>
            </c:choose>

            <button class="btn btn-info" type="button" id="configButton">commit</button>
        </form>
    </div>
