$(function () {
    let detailsPageClass = new IntroductionClass();
    detailsPageClass.setSubmitButtonOnClick();
    detailsPageClass.setOrderButtonOnClick();
    detailsPageClass.search(1);
});
class IntroductionClass extends Fenye {
    constructor() {
        super();
        this.form = $("#form");
